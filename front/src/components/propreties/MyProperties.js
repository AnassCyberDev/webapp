...
const MyProperties = ({id}) => {
    ...
    const deleteProperty=async(id)=>{
        ...
        console.log('proprety',id,'deleted')
    }
            ...
            <li>
                ...
                <div className="col-xs-12 col-sm-12 col-md-8">
                    <div className="row">
                        ...
                        ((propreties[key].author_id == id )?<Propreties id={propreties[key].id} key={index} title={propreties[key].title} type={propreties[key].post_type} nature={propreties[key].element_type} city={propreties[key].city} price={propreties[key].price} image={(propreties[key].images)[0]} onDelete={deleteProperty} my={1} valid={propreties[key].is_valid}/> :<div></div> )
